      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">franckyeptie@gmail.com</p>
            <p className="text-gray-600">+237-699-619-034</p>
          </div>
          ...
          {/* Colonne 3 : Horaires */}
          <div>
            <h3 className="text-lg font-semibold mb-3">Horaires de passage</h3>
