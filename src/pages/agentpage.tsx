...
<div className="mt-8 p-4 bg-teal-50 rounded-lg border border-teal-200" >
    <h3 className="text-sm font-medium text-teal-800 mb-2" > Comptes de démonstration: </h3>
        < div className = "space-y-2 text-xs text-teal-700" >
            <div>
            <strong>Agent : </strong> yana@joy-ci.com / admin1
                </div>
                < div >
                <strong>Agent : </strong> adele@joy-ci.com / admin2
                    </div>
                    < div >
                    <strong>Superviseur : </strong> monthe@joy-ci.com/ admin123
                        </div>
                        </div>
                        </div>
                        </div>
...
className = {`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${signalement.statut === 'en_attente'
...
className = {`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${signalement.statut === 'en_cours'
...
className = {`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${signalement.statut === 'realise'
